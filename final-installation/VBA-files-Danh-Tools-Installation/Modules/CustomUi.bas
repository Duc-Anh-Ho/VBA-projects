...
Private multipleReplaceButton As CustomUITag
...
Private Sub configTags()
    ...
    With hidePageBreakDropDown
        ...
        .letImage = ""
        .letKeytip = ""
        .letScreentip = "Hide/Show Page Break"
        .letSupertip = _
            "Hide and show break page in current sheet or all sheets."
    End With
    
    Set multipleReplaceButton = New CustomUITag
    With multipleReplaceButton
        .letEnabled = isOnAutoArrange
        .letVisible = ALWAYS_SHOW
        .letShowImage = ALWAYS_SHOW
        .letShowLabel = ALWAYS_SHOW
        .letID = "multiple-replace"
        .letSize = SIZE_NORMAL
        .letLabel = "Multiple Replace"
        .letDescription = ""
        .letImage = ""
        .letKeytip = ""
        .letScreentip = "Multiple Replacment"
        .letSupertip = _
            "Find and replace mutiple value as ranges selection."
    End With
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getSize
...
'    Call setUpEnabled
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getEnabled
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getShowImage
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getKeytip
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getLabel
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getShowLabel
        Case hidePageBreakDropDown.getID
            Let returnedVal = multipleReplaceButton.getShowLabel
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getScreentip
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getSupertip
        Case boldFirstLineButton.getID
...
On Error GoTo ErrorHandle
    ...
    Select Case control.id
        ...
        Case multipleReplaceButton.getID
            Let returnedVal = multipleReplaceButton.getVisible
        Case boldFirstLineButton.getID
